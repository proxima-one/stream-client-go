...
const (
	StreamConsumerService_FindStream_FullMethodName             = "/stream_consumer.v1alpha1.StreamConsumerService/FindStream"
	StreamConsumerService_FindOffset_FullMethodName             = "/stream_consumer.v1alpha1.StreamConsumerService/FindOffset"
	StreamConsumerService_GetStateTransitions_FullMethodName    = "/stream_consumer.v1alpha1.StreamConsumerService/GetStateTransitions"
	StreamConsumerService_StreamStateTransitions_FullMethodName = "/stream_consumer.v1alpha1.StreamConsumerService/StreamStateTransitions"
)
...
func (c *streamConsumerServiceClient) FindStream(ctx context.Context, in *FindStreamRequest, opts ...grpc.CallOption) (*FindStreamResponse, error) {
	...
	err := c.cc.Invoke(ctx, StreamConsumerService_FindStream_FullMethodName, in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *streamConsumerServiceClient) FindOffset(ctx context.Context, in *FindOffsetRequest, opts ...grpc.CallOption) (*FindOffsetResponse, error) {
	...
	err := c.cc.Invoke(ctx, StreamConsumerService_FindOffset_FullMethodName, in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *streamConsumerServiceClient) GetStateTransitions(ctx context.Context, in *GetStateTransitionsRequest, opts ...grpc.CallOption) (*GetStateTransitionsResponse, error) {
	...
	err := c.cc.Invoke(ctx, StreamConsumerService_GetStateTransitions_FullMethodName, in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *streamConsumerServiceClient) StreamStateTransitions(ctx context.Context, in *StreamStateTransitionsRequest, opts ...grpc.CallOption) (StreamConsumerService_StreamStateTransitionsClient, error) {
	stream, err := c.cc.NewStream(ctx, &StreamConsumerService_ServiceDesc.Streams[0], StreamConsumerService_StreamStateTransitions_FullMethodName, opts...)
	if err != nil {
		return nil, err
	}
...
func _StreamConsumerService_FindStream_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: StreamConsumerService_FindStream_FullMethodName,
	}
...
func _StreamConsumerService_FindOffset_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: StreamConsumerService_FindOffset_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
...
func _StreamConsumerService_GetStateTransitions_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: StreamConsumerService_GetStateTransitions_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
