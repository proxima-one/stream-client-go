...
import (
	pbModel "github.com/proxima-one/stream-client-go/v2/api/proto/gen/proto/go/model/v1"
	pbConsumerModel "github.com/proxima-one/stream-client-go/v2/api/proto/gen/proto/go/stream_consumer/v1alpha1"
)
